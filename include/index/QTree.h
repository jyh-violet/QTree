...
public:
    ...
    bool findAndRemoveRelatedQueries(int attribute, list<QueryMeta*>* removedQuery);
...
template<typename K, typename V>
bool QTree<K, V>::findAndRemoveRelatedQueries(int attribute, list<QueryMeta*>* removedQuery){
